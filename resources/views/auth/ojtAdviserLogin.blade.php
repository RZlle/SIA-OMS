...
<body>
    ...
    <div class="login-container">
        ...
        <div id="main-login-form" style="width:30%;">
            ...
            <h3 id="system-names"><strong>OJT Management System</strong><br> <span style="color: #800000">Student
        ...
        $(document).ready(function() {
            $('#ojt-coor-sign-in').click(function() {
                axios.post('http://sms-oms.test/api/auth/login', {
                    'UserName': $('#ojt-adviser-username').val(),
                    'Password': $('#ojt-adviser-password').val(),
                })
                .then(response => {
                    if(response.data.status && response.data.Usertype == "ADVI") {
                        alert('Login Successful!');
                        window.location.href = 'WALA PANG ROUTE';
                    } else {
                        alert('Login failed');
                    }
                })
