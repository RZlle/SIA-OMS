...
(function (t) {
    ...
    function l(i, n) {
        ...
        function f(e, i) {
            he++,
                ...
                re &&
                    ...
                    (re.start &&
                        !e &&
                        le.isWithin(re.intervalStart, re.intervalEnd)) ||
                        (h() &&
                            (I(),
                            re.start && re.destroy(),
                            re.render(le),
        ...
        (q.defaultAllDayEventDuration = e.duration(
            ...
            (q.moment = function () {
                ...
                return (
                    "local" === K.timezone
                        ? ((t = He.moment.apply(null, arguments)),
                          t.hasTime() && t.local())
                        : (t =
                              "UTC" === K.timezone
    ...
    function c(e) {
        ...
        function o(i, n) {
            ...
            for (r = 0; l.length > r; r++) {
                if (
                    ((s = l[r].call(S, i, T.clone(), C.clone(), e.timezone, n)),
                    s === !0)
                )
                    return;
        ...
        function g(t, e) {
            ...
            i &&
                (i.source ||
                    (e && (z.events.push(i), (i.source = z)), A.push(i)),
                R(A));
        }
        function p(e) {
            var i, n;
            for (
                ...
                t.isArray(L[n].events) &&
                    (L[n].events = t.grep(L[n].events, e, !0));
            R(A);
        }
        function m(e) {
            ...
            return (
                ...
                ((o = null), !i.end || ((o = S.moment(i.end)), o.isValid()))
                    ? ((s = i.allDay),
                      void 0 === s &&
                          ((l = M(
                              n ? n.allDayDefault : void 0,
                              e.allDayDefault
                          )),
                          (s =
                              void 0 !== l
                                  ? l
                                  : !(r.hasTime() || (o && o.hasTime())))),
                      s
        ...
        function E(t, e, i) {
            ...
            return (
                ...
                n != l
                    ...
                    : i &&
                      (o = D(
                          i || S.getDefaultEventEnd(n, e || a),
                          e || a
                      ).subtract(D(c || S.getDefaultEventEnd(l, a), a))),
                (s = b(m(t._id), d, n, r, o)),
                { dateDelta: r, durationDelta: o, undo: s }
            );
        }
        ...
        g(e),
            e.each(function (i, n) {
                var d = i === e.length - 1 ? o : r,
                    h = t(n).outerHeight(!0);
                d > h
                    ? (s.push(n), l.push(h), a.push(t(n).height()))
                    : (c += h);
            }),
            n &&
                ((i -= c),
        ...
        return e > i && n > t
            ? (t >= i
              ...
              n >= e
                  ? ((o = e.clone()), (l = !0))
                  : ((o = n.clone()), (l = !1)),
              { start: r, end: o, isStart: s, isEnd: l })
            : void 0;
    }
    function S(t, e) {
    ...
    function ie(t, e) {
        ...
        for (i = 0; e.length > i; i++)
            if (
                ((n = e[i]), n.leftCol <= t.rightCol && n.rightCol >= t.leftCol)
            )
                return !0;
        return !1;
    }
    ...
    function fe(i) {
        ...
        function r(t, e) {
            return i.trigger.apply(
                i,
                [t, e || C].concat(Array.prototype.slice.call(arguments, 2), [
                    C,
                ])
            );
        }
        ...
        function p(t) {
            var e = C.start.day();
            return (
                (t += L[e]), 7 * Math.floor(t / R) + G[((t % R) + R) % R] - e
            );
        }
        function m(t) {
        ...
        function w(t) {
            var e = C.start.day();
            return (
                (t += e), Math.floor(t / 7) * R + L[((t % 7) + 7) % 7] - L[e]
            );
        }
        function E(t) {
            var e = C.colCnt,
    ...
    (j.prototype = {
        ...
        position: function () {
            ...
            (r = s.top || 0),
                ...
                this.el.css({ top: r - l.top, left: o - l.left });
        },
        trigger: function (t) {
            this.options[t] &&
        ...
        t.extend(J.prototype, {
                ...
                t.each(
                    {
                        ...
                        mousedown: function (n, r) {
                            ...
                            i.isEventResizable(n.event)
                                ? e.segResizeMousedown(n, r)
                                : i.isEventDraggable(n.event) &&
                                  e.segDragMousedown(n, r);
                        },
                    },
                    function (i, n) {
            ...
            getSegClasses: function (t, e, i) {
                var n = t.event,
                    ...
                    ].concat(n.className, n.source ? n.source.className : []);
                return (
                    e && r.push("fc-draggable"), i && r.push("fc-resizable"), r
                );
            },
        ...
        t.extend(ee.prototype, {
            ...
            getCellSegs: function (t, e) {
                for (
                    var i,
                        n = this.rowStructs[t.row].segMatrix,
                        r = e || 0,
                        o = [];
                    n.length > r;
        ...
        t.extend(re.prototype, {
            ...
            getCellDate: function (t) {
                ...
                return i.rezoneDate(
                    e
                        .cellToDate(0, t.col)
                        .time(this.minTime + this.snapDuration * t.row)
                );
            },
            getCellDayEl: function (t) {
            ...
            destroyHelper: function () {
                this.helperEl &&
                    (this.helperEl.remove(), (this.helperEl = null));
            },
            renderSelection: function (t, e) {
                ...
                return (
                    ...
                    '<a class="' +
                        ...
                        (i
                            ...
                            : "") +
                        (s.title
                            ? '<div class="fc-title">' + R(s.title) + "</div>"
                            : "") +
                        "</div>" +
                        '<div class="fc-bg"/>' +
        ...
        t.extend(pe.prototype, {
            ...
            render: function (t) {
                ...
                (this.intervalStart = t.clone().stripTime().startOf("month")),
                    ...
                    this.isFixedWeeks() &&
                        (this.end.add(6 - e, "weeks"), (e = 6)),
                    (this.title = this.calendar.formatDate(
                        this.intervalStart,
                        this.opt("titleFormat")
                    )),
                    ge.prototype.render.call(
                        this,
                        e,
        ...
        t.extend(ve.prototype, {
            ...
            render: function (t) {
                (this.start = this.intervalStart = t.clone().stripTime()),
                    (this.end = this.intervalEnd =
                        this.start.clone().add(1, "days")),
                    (this.title = this.calendar.formatDate(
                        this.start,
                        this.opt("titleFormat")
                    )),
